...
class TestOnlineDeploymentSDK:
    ...
    def test_deployment_from_rest_object_for_online_deployment(self) -> None:
        from azure.ai.ml._restclient.mgmtmachinelearningservices.models import OnlineDeployment as OnlineDeploymentDataRest
...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import BatchRetrySettings as RestBatchRetrySettings
