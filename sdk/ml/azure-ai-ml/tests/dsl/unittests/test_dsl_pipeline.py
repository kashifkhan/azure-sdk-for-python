...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import ComponentContainer as ComponentContainerData, ComponentContainerProperties as ComponentContainerDetails, SystemData
