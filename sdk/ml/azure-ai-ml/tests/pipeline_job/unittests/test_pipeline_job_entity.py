...
class TestPipelineJobEntity:
    ...
    def test_pipeline_input_as_runsettings_value(self, client: MLClient) -> None:
        ...
        rest_obj = pipeline._to_rest_object()
        expect_resource = {"instanceCount": "${{parent.inputs.integer}}", "shmSize": "${{parent.inputs.shm_size}}"}
    ...
    def test_pipeline_job_serverless_compute_with_job_tier(self) -> None:
        ...
        assert rest_obj.properties.jobs["spot_job_tier"]["queue_settings"] == {"jobTier": "Spot"}
        assert rest_obj.properties.jobs["standard_job_tier"]["queue_settings"] == {"jobTier": "Standard"}
    ...
    def test_pipeline_job_sweep_with_job_tier_in_pipeline(self) -> None:
        ...
        pipeline_job = load_job(yaml_path)
        # TypeSpec uses capitalized job tier values
        rest_obj = pipeline_job._to_rest_object()
        assert rest_obj.properties.jobs["node"]["queue_settings"] == {"jobTier": "Standard"}
    ...
    def test_pipeline_job_automl_with_job_tier_in_pipeline(self) -> None:
        ...
        # TypeSpec uses capitalized job tier values
        rest_obj = pipeline_job._to_rest_object()
        assert rest_obj.properties.jobs["text_ner_node"]["queue_settings"] == {"jobTier": "Spot"}
