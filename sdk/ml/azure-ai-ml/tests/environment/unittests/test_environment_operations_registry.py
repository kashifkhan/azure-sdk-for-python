...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import EnvironmentVersion as EnvironmentVersionData, EnvironmentVersionProperties as EnvironmentVersionDetails
