...
class MachineLearningServicesMgmtClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype operations: mgmtmachinelearningservices.operations.Operations
    :ivar workspaces: WorkspacesOperations operations
    :vartype workspaces: mgmtmachinelearningservices.operations.WorkspacesOperations
    :ivar code_containers: CodeContainersOperations operations
    :vartype code_containers: mgmtmachinelearningservices.operations.CodeContainersOperations
    :ivar registries: RegistriesOperations operations
    :vartype registries: mgmtmachinelearningservices.operations.RegistriesOperations
    :ivar code_versions: CodeVersionsOperations operations
    :vartype code_versions: mgmtmachinelearningservices.operations.CodeVersionsOperations
    :ivar component_containers: ComponentContainersOperations operations
    :vartype component_containers:
     mgmtmachinelearningservices.operations.ComponentContainersOperations
    :ivar component_versions: ComponentVersionsOperations operations
    :vartype component_versions: mgmtmachinelearningservices.operations.ComponentVersionsOperations
    :ivar data_containers: DataContainersOperations operations
    :vartype data_containers: mgmtmachinelearningservices.operations.DataContainersOperations
    :ivar data_versions: DataVersionsOperations operations
    :vartype data_versions: mgmtmachinelearningservices.operations.DataVersionsOperations
    :ivar environment_containers: EnvironmentContainersOperations operations
    :vartype environment_containers:
     mgmtmachinelearningservices.operations.EnvironmentContainersOperations
    :ivar environment_versions: EnvironmentVersionsOperations operations
    :vartype environment_versions:
     mgmtmachinelearningservices.operations.EnvironmentVersionsOperations
    :ivar model_containers: ModelContainersOperations operations
    :vartype model_containers: mgmtmachinelearningservices.operations.ModelContainersOperations
    :ivar model_versions: ModelVersionsOperations operations
    :vartype model_versions: mgmtmachinelearningservices.operations.ModelVersionsOperations
    :ivar batch_endpoints: BatchEndpointsOperations operations
    :vartype batch_endpoints: mgmtmachinelearningservices.operations.BatchEndpointsOperations
    :ivar batch_deployments: BatchDeploymentsOperations operations
    :vartype batch_deployments: mgmtmachinelearningservices.operations.BatchDeploymentsOperations
    :ivar capability_hosts: CapabilityHostsOperations operations
    :vartype capability_hosts: mgmtmachinelearningservices.operations.CapabilityHostsOperations
    :ivar datastores: DatastoresOperations operations
    :vartype datastores: mgmtmachinelearningservices.operations.DatastoresOperations
    :ivar featureset_containers: FeaturesetContainersOperations operations
    :vartype featureset_containers:
     mgmtmachinelearningservices.operations.FeaturesetContainersOperations
    :ivar features: FeaturesOperations operations
    :vartype features: mgmtmachinelearningservices.operations.FeaturesOperations
    :ivar featureset_versions: FeaturesetVersionsOperations operations
    :vartype featureset_versions:
     mgmtmachinelearningservices.operations.FeaturesetVersionsOperations
    ...
    :vartype registry_environment_containers:
     mgmtmachinelearningservices.operations.RegistryEnvironmentContainersOperations
    :ivar registry_environment_versions: RegistryEnvironmentVersionsOperations operations
    :vartype registry_environment_versions:
     mgmtmachinelearningservices.operations.RegistryEnvironmentVersionsOperations
    :ivar registry_model_containers: RegistryModelContainersOperations operations
    :vartype registry_model_containers:
     mgmtmachinelearningservices.operations.RegistryModelContainersOperations
    :ivar registry_model_versions: RegistryModelVersionsOperations operations
    :vartype registry_model_versions:
     mgmtmachinelearningservices.operations.RegistryModelVersionsOperations
    :ivar jobs: JobsOperations operations
    :vartype jobs: mgmtmachinelearningservices.operations.JobsOperations
    :ivar workspace_connections: WorkspaceConnectionsOperations operations
    :vartype workspace_connections:
     mgmtmachinelearningservices.operations.WorkspaceConnectionsOperations
    :ivar managed_network_settings_rule: ManagedNetworkSettingsRuleOperations operations
    :vartype managed_network_settings_rule:
     mgmtmachinelearningservices.operations.ManagedNetworkSettingsRuleOperations
    :ivar usages: UsagesOperations operations
    :vartype usages: mgmtmachinelearningservices.operations.UsagesOperations
    :ivar virtual_machine_sizes: VirtualMachineSizesOperations operations
    :vartype virtual_machine_sizes:
     mgmtmachinelearningservices.operations.VirtualMachineSizesOperations
    :ivar quotas: QuotasOperations operations
    :vartype quotas: mgmtmachinelearningservices.operations.QuotasOperations
