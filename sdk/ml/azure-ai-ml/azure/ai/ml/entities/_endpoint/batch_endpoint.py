...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import BatchEndpoint as BatchEndpointData
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import BatchEndpointProperties as RestBatchEndpoint
