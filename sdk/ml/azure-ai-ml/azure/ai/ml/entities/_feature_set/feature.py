...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import Feature as RestFeature
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import FeatureProperties
