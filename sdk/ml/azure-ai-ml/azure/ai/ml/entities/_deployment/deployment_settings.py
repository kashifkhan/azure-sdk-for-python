...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import OnlineRequestSettings as RestOnlineRequestSettings
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import ProbeSettings as RestProbeSettings
