...
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import BatchDeployment as BatchDeploymentData
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import BatchDeploymentProperties as RestBatchDeployment
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import CodeConfiguration as RestCodeConfiguration
from azure.ai.ml._restclient.mgmtmachinelearningservices.models import IdAssetReference
