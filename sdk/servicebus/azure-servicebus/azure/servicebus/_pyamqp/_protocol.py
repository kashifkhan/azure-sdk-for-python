...
class WebSocketProtocol(WebSocketMixin):
    ...
    def close(self, code: int = CloseReason.NORMAL, reason: bytes = b"") -> None:
        ...
        :param int code: WebSocket close code (default: CloseReason.NORMAL)
        :param bytes reason: Close reason (default: empty)
        :raises WebSocketConnectionError: If connection is already closed
        :raises ValueError: If invalid close code provided
        """
